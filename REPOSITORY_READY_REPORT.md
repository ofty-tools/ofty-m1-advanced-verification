...
**Build:** v0.4.5  ·  **Release tag (planned):** `v0.4.5-verification-freeze`  ·  **License:** MIT
**Release URL:** https://github.com/ofty-tools/ofty-m1-advanced-verification/releases/tag/v0.4.5-verification-freeze  ·  **Final commit:** 47dfc98
