...
Reproducibility package accompanying the manuscript on **OFTY M1 Advanced**, a deterministic, client-side, browser-based software module that contextualizes heterogeneous device-derived intraocular-pressure (IOP) measurements **without fusing them**.
...
Release tag: **`v0.4.5-verification-freeze`**
Release: https://github.com/ofty-tools/ofty-m1-advanced-verification/releases/tag/v0.4.5-verification-freeze
Final commit: 47dfc98
